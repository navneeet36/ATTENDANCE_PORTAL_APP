...
import com.example.hp.attendamce_portal.Fragments.ShowDayWiseAttendance;
...
public class FacultyPage extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position == 0)
                return ShowFacultyInfo.newInstance(position+1);

            else if(position == 1)
                return AddAttendance.newInstance(position+1);
            else
                return ShowDayWiseAttendance.newInstance(position+1);
        }
