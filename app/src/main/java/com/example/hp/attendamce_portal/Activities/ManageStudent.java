...
import com.example.hp.attendamce_portal.Fragments.SearchStudent;
import com.example.hp.attendamce_portal.Fragments.ShowStudent;
import com.example.hp.attendamce_portal.R;

public class ManageStudent extends BaseActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position == 0)
                return ShowStudent.newInstance(position+1);
            else
                return SearchStudent.newInstance(position+1);
        }
